    ...
    <div class="index">
        ...
        <div>
            ...
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ad quia cupiditate obcaecati dolorum, ex quas sit delectus,
                ...
                repellendus autem possimus necessitatibus.</p>
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    data() {
        return {
            ...
            employe: [
                { name: "Sarthik", department: "Frontend", show: false },
                { name: "Sunny", department: "Backend", show: false },
                { name: "Bunty", department: "Html", show: false },
    ...
    methods: {
        ...
        input() {
            return this.data = this.$refs.data.value
        },
        troy11() {
            return "I'm Back"
        },
